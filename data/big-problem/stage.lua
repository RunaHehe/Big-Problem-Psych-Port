...
function opponentNoteHit(membersIndex, noteData, noteType, isSustainNote)
    ...
    if not disableDadTextTyping and not dontSing then 
        ...
        setTextString("googleChat", getTextString("googleChat")..((empty or sus) and "" or " ")..text)
    end
